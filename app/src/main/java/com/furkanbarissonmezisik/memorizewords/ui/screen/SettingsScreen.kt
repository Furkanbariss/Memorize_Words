            ...
            item {
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(R.string.background_selection_description),
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.onSurfaceVariant,
                            modifier = Modifier.padding(bottom = 8.dp)
                        )
                        ...
                        Column {
                            Row(
                                ...
                                RadioButton(
                                    selected = backgroundManager.currentBackgroundType == BackgroundType.NONE,
                                    onClick = { backgroundManager.setBackgroundType(BackgroundType.NONE) }
                                )
                                Spacer(modifier = Modifier.width(8.dp))
                                Text(
                            ...
                            Row(
                                ...
                                RadioButton(
                                    selected = backgroundManager.currentBackgroundType == BackgroundType.COLORFUL_LETTERS,
                                    onClick = { backgroundManager.setBackgroundType(BackgroundType.COLORFUL_LETTERS) }
                                )
                                Spacer(modifier = Modifier.width(8.dp))
                                Text(
                                    text = stringResource(R.string.colorful_letters),
                                    style = MaterialTheme.typography.bodyMedium
                                )
                            }
                            ...
                            Row(
                                ...
                                RadioButton(
                                    selected = backgroundManager.currentBackgroundType == BackgroundType.LIGHT_LETTERS,
                                    onClick = { backgroundManager.setBackgroundType(BackgroundType.LIGHT_LETTERS) }
                                )
                                Spacer(modifier = Modifier.width(8.dp))
                                Text(
                                    text = stringResource(R.string.light_letters),
                                    style = MaterialTheme.typography.bodyMedium
                                )
                            }
                            ...
                            Row(
                                ...
                                RadioButton(
                                    selected = backgroundManager.currentBackgroundType == BackgroundType.DARK_TECH,
                                    onClick = { backgroundManager.setBackgroundType(BackgroundType.DARK_TECH) }
                                )
                                Spacer(modifier = Modifier.width(8.dp))
                                Text(
                                    text = stringResource(R.string.dark_tech),
                                    style = MaterialTheme.typography.bodyMedium
                                )
                            }
                            ...
                            Row(
                                ...
                                RadioButton(
                                    selected = backgroundManager.currentBackgroundType == BackgroundType.EDUCATIONAL_ICONS,
                                    onClick = { backgroundManager.setBackgroundType(BackgroundType.EDUCATIONAL_ICONS) }
                                )
                                Spacer(modifier = Modifier.width(8.dp))
                                Text(
                                    text = stringResource(R.string.educational_icons),
                                    style = MaterialTheme.typography.bodyMedium
                                )
                            }
                        }
                        ...
                        Row(
                            ...
                            val backgroundTypes = listOf(
                                BackgroundType.NONE,
                                BackgroundType.COLORFUL_LETTERS,
                                BackgroundType.LIGHT_LETTERS,
                                BackgroundType.DARK_TECH,
                                BackgroundType.EDUCATIONAL_ICONS
                            )
                            ...
                            backgroundTypes.forEach { backgroundType ->
                                Card(
                                    modifier = Modifier
                                        ...
                                        .padding(4.dp),
                                    colors = CardDefaults.cardColors(
                                        containerColor = if (backgroundType == BackgroundType.NONE) {
                                        ...
                                        modifier = Modifier
                                            ...
                                            .background(
                                                color = when (backgroundType) {
                                                    BackgroundType.NONE -> MaterialTheme.colorScheme.surface
                                                    BackgroundType.COLORFUL_LETTERS -> MaterialTheme.colorScheme.primary.copy(alpha = 0.1f)
                                                    BackgroundType.LIGHT_LETTERS -> MaterialTheme.colorScheme.primary.copy(alpha = 0.05f)
                                                    BackgroundType.DARK_TECH -> MaterialTheme.colorScheme.primary.copy(alpha = 0.2f)
                                                    BackgroundType.EDUCATIONAL_ICONS -> MaterialTheme.colorScheme.primary.copy(alpha = 0.1f)
                                                }
                                            ),
                                        contentAlignment = Alignment.Center
                                    ) {
                                        Text(
                                            text = when (backgroundType) {
                                                BackgroundType.NONE -> "—"
                                                BackgroundType.COLORFUL_LETTERS -> "A"
                                                BackgroundType.LIGHT_LETTERS -> "a"
                                                BackgroundType.DARK_TECH -> "⚡"
                                                BackgroundType.EDUCATIONAL_ICONS -> "📚"
                                            },
                                            style = MaterialTheme.typography.labelSmall,
